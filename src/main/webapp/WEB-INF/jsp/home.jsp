    ...
    <div class="stock-buy-popup__card">
        ...
        <form action="/stock/buy" method="post" modelAttribute="buyStock" class="stock-buy-popup__form">
            <div class="flex-column">
                ...
                <input id="trade-name" class="stock-buy-popup__input" type="text" disabled="true"/>
            </div>
            <div class="flex-column">
                <label class="stock-buy-popup__label">Market name</label>
                <input id="market-name" class="stock-buy-popup__input" type="text" disabled="true"/>
            </div>
            <div class="flex-column">
                <label class="stock-buy-popup__label">Trade price</label>
                <input id="trade-price" class="stock-buy-popup__input" type="number" disabled="true"/>
            </div>
            <div class="flex-column">
                <label class="stock-buy-popup__label">Amount</label>
                <input id="stock-amount" class="stock-buy-popup__input" type="number" min="1" required="true"
                       placeholder="Enter stock amount to buy"/>
            </div>
            <div>
                <button id="submit-btn" type="submit" class="stock-buy-popup__btn auth__btn text text--c-light">Buy
                </button>
            </div>
        </form>
    </div>
